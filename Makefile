...
startup_lm3s6965.elf: startup_lm3s6965.o uart_drv.o kernel.o
	arm-none-eabi-ld -T lm3s6965_layout.ld -o startup_lm3s6965.elf startup_lm3s6965.o uart_drv.o kernel.o
...
clean:
	rm -f startup_lm3s6965.o kernel.o uart_drv.o startup.elf startup.bin
